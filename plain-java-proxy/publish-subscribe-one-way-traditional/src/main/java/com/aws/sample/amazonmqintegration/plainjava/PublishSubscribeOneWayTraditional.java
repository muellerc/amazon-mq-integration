...
public class PublishSubscribeOneWayTraditional {
    ...
    private static final String BROKER_TOPIC = CONFIGURATION_PREFIX + "/BROKER-TOPIC-PUBLISH-SUBSCRIBE-ONE-WAY-TRADITIONAL";
    ...
    private static final String SQS_ENDPOINT = CONFIGURATION_PREFIX + "/SQS-ENDPOINT-PUBLISH-SUBSCRIBE-ONE-WAY-TRADITIONAL";
